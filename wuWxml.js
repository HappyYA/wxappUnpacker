...
function doFrame(name, cb, order, mainDir) {
    ...
    wu.get(name, code => {
        getZ(code, z => {
          fs.writeFileSync('codeWxml.js', code, (err) => {
            if (err) {
            ...
            fs.writeFileSync('codeWxml2.js', code, (err) => {
              if (err) {
                  console.error('Error writing to file', err);
              } else {
                  console.log('Code successfully saved to code.js');
            ...
            fs.writeFileSync('codeWxmljson.js', json, (err) => {
              if (err) {
                  console.error('Error writing to file', err);
              } else {
                  console.log('Code successfully saved to code.js');
            ...
            console.log('endOfRequire: ' + endOfRequire);
            code = code.slice(endOfRequire);
            fs.writeFileSync('codeWxml3.js', code, (err) => {
              if (err) {
                  console.error('Error writing to file', err);
              } else {
                  console.log('Code successfully saved to code.js');
